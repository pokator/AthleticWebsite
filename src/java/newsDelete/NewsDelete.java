...
Directs from admin pages to the NewsDeleteBean to delete a page. 
 */
 ...
 * @author Sourav
 */
@WebServlet(urlPatterns = {"/newsDelete"})
public class NewsDelete extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        NewsDeleteBean bean = new NewsDeleteBean(request.getParameter("published"), request.getParameter("title"));
