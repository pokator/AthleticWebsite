 ...
 * This program updates the calendar/schedule.
 */
package upcoming;
 ...
 * @author Sourav
 */
@WebServlet(name = "ScheduleServlet", urlPatterns = {"/scheduler"})
public class ScheduleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        UpcomingBean upcoming = new UpcomingBean(request.getParameter("team"), request.getParameter("sport"), request.getParameter("date"));
        ...
        //Returns action w/in form that triggered the servlet to be used.
