`<%-- 
    ...
    Author     : Sourav
    Purpose: Is the admin page for the user to edit and add to different information when player entry is successful.
Imports below:
--%>
...
<html>
    ...
    <body>
        ...
        <div class="adminform">
            ...
            <h4 id="invalid">Entry Successful!</h4>
        ...
        <div class="adminform">
            ...
            <form action="newsDelete" method="POST">
                ...
                <select name="published" size="1" required>
                ...
                <br><br>
                <select name="title" size="1" required>
