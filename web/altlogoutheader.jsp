<%-- 
    ...
    Created on : Apr 3, 2018, 4:16:58 PM
    Author     : Sourav
    Description: Alternate Logout Header for Website.
--%>
...
<html>
    ...
    <body>
        ...
        <div id="navbar1">
            ...
            <a href="admin.jsp" class="navlinks1">
                <h2 id="link1">Admin</h2>   
            </a>
            <a href="logout.jsp" class="navlinks1">
                <h2 id="link1">Logout</h2>   
            </a>
        </div>
    </body>
</html>
